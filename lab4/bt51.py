...
def kiem_tra_tam_giac(a, b, c):
    """Kiểm tra ba cạnh có tạo thành tam giác.

    Điều kiện: tổng hai cạnh lớn hơn cạnh còn lại.
    ...
    Returns:
        bool: True nếu tạo thành tam giác, False nếu không.
    """
...
def tinh_cao(a, b, c):
    """Tính chiều cao tương ứng mỗi cạnh của tam giác.
    ...
    Returns:
        tuple[float, float, float]: (ha, hb, hc) hoặc (0,0,0) nếu không hợp lệ.
    """
...
def main():
    """Hàm chính: nhập 3 cạnh, kiểm tra tam giác và in diện tích, chiều cao."""
    ...
    if kiem_tra_tam_giac(a, b, c):
        ...
        print(
            f"Chiều cao tương ứng là: ha = {ha:.2f}, hb = {hb:.2f}, hc = {hc:.2f}")
    else:
