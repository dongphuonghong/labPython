#  Bài 78: In vị trí các phần tử nguyên tố trong danh sách.
...
def inViTriSoNguyenTo(lst):
    """In vị trí các phần tử nguyên tố trong danh sách.

    Args:
        lst (list[int]): Danh sách số nguyên.
    """
    for i in range(len(lst)):
        if kiemTraSoNguyenTo(lst[i]):
            print("Vị trí số nguyên tố trong danh sách là:", i)
